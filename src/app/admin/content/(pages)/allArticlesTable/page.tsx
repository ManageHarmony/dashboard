...
export default function AllConsultants() {
    ...
    const handleEdit = (article: topArticles) => {
        // Example logic for editing
        localStorage.setItem('editArticleData', JSON.stringify(article));
        ...
        <div style={{ padding: "20px 30px" }}>
            <div style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <h1 className="text-xl font-bold mb-4">Top Articles</h1>
                                ...
                                {topArticles.length > 0 ? (
                                    topArticles.map((article, index) => (
                                        <tr key={article.id} className="border-b border-gray-300">
                                            ...
                                            <td className="p-2 text-left text-black">{article.heading}</td>
                                            <td className="p-2 text-left text-black">{article.views}</td>
                                    ...
                                    <tr>
                                        <td colSpan={4} className="p-2 text-center text-gray-600">No articles found</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
