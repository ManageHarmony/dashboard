        ...
        <>
            <div style={{ display: "flex", flexDirection: "column", gap: "20px", width: "100%" }}>
                ...
                <div style={{
                    ...
                    {!loading ? (topServiceCategory.length > 0 ? (<div style={{
                        height: "calc(100px - 40px)", // Fixed height, adjust if necessary
                        overflowY: "hidden", // Enable scroll when showAll is true
                        borderRadius: "10px"
                    }}>
                            ...
                            <tbody>
                                {topServiceCategory?.map((data, index) => (
                                    <tr key={data.id} className="border-b border-gray-300">
                                        ...
                                        <td className="p-2 text-black">{truncateText(data.serviceId, 25)}</td>
